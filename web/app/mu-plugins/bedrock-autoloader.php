 ...
 *   The autoloaded plugins are included during mu-plugin loading. An asterisk (*) next to the name of the plugin
 *   designates the plugins that have been autoloaded.
 * Version: 1.0.0
 * Author: Roots
